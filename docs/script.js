                    ...
                    ${isExternalVideo ? 
                        (isHeyGen ? 
                            `<div class="heygen-video-container">
                                <div class="video-direct-access">
                                    <div class="video-thumbnail">
                                        <i class="fas fa-play-circle"></i>
                                        <h3>AI-Generated Training Video</h3>
                                        <p>Click below to watch your HeyGen AI training video</p>
                                        <div class="video-buttons">
                                            <button onclick="window.open('${videoInfo.videoUrl}', '_blank')" class="btn btn-primary btn-lg">
                                                <i class="fas fa-play"></i> Watch HeyGen Video
                                            </button>
                                        </div>
                                        <p class="video-note">
                                            <i class="fas fa-info-circle"></i>
                                            Video will open in a new tab for the best viewing experience
                                        </p>
                                    </div>
                                </div>
